       ...
       <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="columns" id="input-status" class="form-control">
                ...
                <?php if ($columns == 'col-sm-6') { ?>
                <option value="col-sm-6" selected="selected"><?php echo $text_col2; ?></option>
                <?php } else { ?>
                <option value="col-sm-6"><?php echo $text_col2; ?></option>
                <?php } ?>
                
                <?php if ($columns == 'col-sm-4') { ?>
                <option value="col-sm-4" selected="selected"><?php echo $text_col3; ?></option>
                <?php } else { ?>
                <option value="col-sm-4"><?php echo $text_col3; ?></option>
                <?php } ?>
         ...
         <table id="sections" class="table table-striped table-bordered table-hover">
            <thead>
              <tr>
                <td class="text-left" width="20%"><?php echo $entry_background; ?></td>
            ...
            <tbody>
              ...
              <tr id="section-row<?php echo $section_row; ?>">
                ...
                <div class="input-group">
                <span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['language_id']; ?>" /></span>
                    <a href="" id="thumb-image<?php echo $section_row; ?><?php echo $language['language_id']; ?>" data-toggle="image" class="img-thumbnail">
                    <img src="<?php echo isset($section['image'][$language['language_id']]) ? $section['image'][$language['language_id']] : $placeholder; ?>" 
                    alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                        <input type="hidden" name="sections[<?php echo $section_row; ?>][thumb_image][<?php echo $language['language_id']; ?>]" 
                        value="<?php echo isset($section['thumb_image'][$language['language_id']]) ? $section['thumb_image'][$language['language_id']] : ''; ?>" 
                        id="input-image<?php echo $section_row; ?><?php echo $language['language_id']; ?>" />
                </div>
                <?php } ?>
                </td>
                ...
                <input type="text" class="form-control" name="sections[<?php echo $section_row; ?>][block]" 
                        value="<?php echo isset($section['block']) ? $section['block'] : ''; ?>" 
                        id="input-block<?php echo $section_row; ?>" />
                </td>
...
function addRow() {
	...
	html += '<a href="" id="thumb-image' + section_row + '<?php echo $language['language_id']; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="sections[' + section_row + '][thumb_image][<?php echo $language['language_id']; ?>]" value="" id="input-image' + section_row + '<?php echo $language['language_id']; ?>" />';
	html += '</div>';
	<?php } ?>
	html += '  </td>';
	...
	html += '<input type="text" class="form-control" name="sections[' + section_row + '][block]" id="description-' + section_row + '"/>';
