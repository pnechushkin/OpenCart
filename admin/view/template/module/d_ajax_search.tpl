        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-search" class="form-horizontal">
          ...
          <div class="form-group">
			...
			<!-- Fixed to 100% -->
              ...
              <input type="hidden" class="form-control" name="d_ajax_search[search_width]" value="<?php echo $d_ajax_search['search_width']; ?>"  />
              <?php } else { ?>
              <input type="hidden" class="form-control" name="d_ajax_search[search_width]" value="100%"  />
              <?php } ?>
