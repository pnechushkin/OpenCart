        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-layout" class="form-horizontal">
          ...
          <table id="route" class="table table-striped table-bordered table-hover">
            ...
            <tbody>
              ...
              $is_home = TRUE;
              } else if($layout_route['route'] == 'product/product') {
              $is_product = TRUE;
              } else if($layout_route['route'] == 'product/category') {
              $is_category = TRUE;
              } ?>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <?php if ($name == 'Footer' || $name == 'footer') { ?> 
                 ...
                 <?php } else { ?>   
                    ...
                    <?php if ($layout_module['position'] == 'home_top') { ?>
                    <option value="home_top" selected="selected">Above content</option>
                    <?php } else { ?>
                    <option value="home_top">Above content</option>
                    <?php } ?>
                    <?php } ?>
                    ...
                    <?php if ($layout_module['position'] == 'in_content') { ?>
                    <option value="in_content" selected="selected">Within content (above tabs)</option>
                    <?php } else { ?>
                    <option value="in_content">Within content (above tabs)</option>
                    <?php } ?>
                    <?php } ?>
                    
                    <?php if (isset($is_category)) { ?>
                    <?php if ($layout_module['position'] == 'in_content') { ?>
                    <option value="in_content" selected="selected">Within content (above products)</option>
                    <?php } else { ?>
                    <option value="in_content">Within content (above products)</option>
                    <?php } ?>
                    <?php } ?>
                    ...
                    <?php if (isset($is_home)) { ?>
                    <?php if ($layout_module['position'] == 'home_bottom') { ?>
                    <option value="home_bottom" selected="selected">Below content</option>
                    <?php } else { ?>
                    <option value="home_bottom">Below content</option>
                    <?php } ?>
                    <?php } ?>
...
function addModule() {
	...
	<?php } else { ?>
	<?php if (isset($is_home)) { ?>
	html += '    <option value="home_top">Above content</option>';
	<?php } ?>
	html += '    <option value="content_top"><?php echo $text_content_top; ?></option>';
	<?php if (isset($is_product)) { ?>
	html += '    <option value="in_content">Within content (above tabs)</option>';
	<?php } ?>
	<?php if (isset($is_category)) { ?>
	html += '    <option value="in_content">Within content (above products)</option>';
	<?php } ?>
	...
	<?php } ?>
	<?php if (isset($is_home)) { ?>
	html += '    <option value="home_bottom">Below content</option>';
	<?php } ?>
    html += '  </select></td>';
