<?php
// Heading
$_['heading_title']		= 'Shopme Live Search';
...
$_['text_success']					= 'Success: You have modified module Shopme Live Search';
$_['text_module']         			= 'Module';

// Entry
$_['entry_search_on_off']			= 'Status';
...
$_['entry_search_priority'] 		= 'Enable/Priority of search results';
$_['entry_search_class'] 			= 'Set selector of the search feild';
$_['entry_search_price'] 			= 'Display product prices';
$_['entry_search_special'] 			= 'Display product special prices';
$_['entry_search_tax'] 				= 'Display prices with tax';
$_['text_type']						= 'Item';
...
$_['tooltip_search_priority'] 		= 'Select which elements to include in the search by checking the checkboxes. Items with lowest sort order will appear first among the results';
...
// Error
$_['error_permission']				= 'Warning: You do not have permission to modify module Shopme Live Search';
