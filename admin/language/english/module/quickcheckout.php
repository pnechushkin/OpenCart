<?php
// Heading
$_['heading_title']    						= 'Shopme One Page Checkout';
...
$_['text_success']     						= 'Success: You have modified module Quick Checkout!';
$_['text_edit']								= 'Edit Module Quick Checkout';
$_['text_general']							= 'Configure General Settings to get started.';
$_['text_technical']						= 'Configure Technical Settings for the advanced users.';
$_['text_field']							= 'Configure your Checkout Fields here.';
$_['text_survey']							= 'Configure your Survey Form here.';
$_['text_module_home']						= 'Configure your Checkout Modules here.';
$_['text_delivery']							= 'Configure your Delivery Function here.';
$_['text_countdown']						= 'Configure your Countdown Timer here.';
$_['text_support_home']						= 'Request help from the OpenCart experts.';
...
$_['help_slide_effect']						= 'Sliding effect for transition between details and order confirmation page.';
$_['help_debug']							= 'Turn on debug mode for checkout. Only turn this on if you know what you are doing.';
$_['help_auto_submit']						= 'System attempts to skip order confirmation page for payment methods without the need to fill in additional details on the confirmation page. Disable this function if you are unable to complete the checkout or payment requires additional details on the confirmation page.';
$_['help_responsive']						= 'Only select this if you are using a responsive theme.';
$_['help_country_reload']					= 'Only enable if you had disabled the zone field and the country field is enabled. Disable to reduce ajax requests.';
...
$_['help_delivery_unavailable']				= 'Exclude the listed dates from delivery. &quot;dd-mm-yyyy&quot;, &quot;dd-mm-yyyy&quot; format, within inverted quotes and also comma separated. Leading zeroes.';
...
$_['entry_country_reload']					= 'Country Reloads Cart';
...
$_['entry_delivery_min_hour']				= 'Delivery Minimum Hours';
...
// Error
$_['error_permission'] 						= 'Warning: You do not have permission to modify module Quick Checkout!';

// Mail
$_['mail_success']							= 'You have successfully contacted MarketInSG\'s Support';
$_['mail_error_name']						= 'Name must be between 3 and 16 characters';
...
$_['button_purchase']						= 'Purchase Quick Checkout';
$_['button_review']							= 'Rate Quick Checkout';
$_['tab_about']								= 'About';
$_['entry_mail_name']						= 'Your Name';
$_['entry_mail_email']						= 'Email Address';
$_['entry_mail_order_id']					= 'Order ID';
$_['entry_mail_message']					= 'Message';
$_['text_need_support']						= 'Need support? Fill up the form below to open a support ticket.';
