...
class ControllerModuleNewsletter extends Controller {
	...
	public function index() {
		...
		if (!isset($this->request->get['module_id'])) {
			...
			$data['breadcrumbs'][] = array(
				'text' => $this->language->get('heading_title'),
				'href' => $this->url->link('module/newsletter', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL')
			);			
		}
		...
		if (!isset($this->request->get['module_id'])) {
			...
			$data['action'] = $this->url->link('module/newsletter', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL');
		}
	...
	public function install() {
		...
		$this->model_module_newsletter->createDatabaseTable();
	...
	public function uninstall() {
		$this->load->model('module/newsletter');
		$this->model_module_newsletter->dropDatabaseTable();
	}
