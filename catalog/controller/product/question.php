...
class ControllerProductQuestion extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/question.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/product/question.tpl', $data);
		} else {
			return $this->load->view('default/template/product/question.tpl', $data);
		}
	}
	...
	public function question_list () {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/question_list.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/product/question_list.tpl', $data));
		} else {
			$this->response->setOutput($this->load->view('default/template/product/question_list.tpl', $data));
		}
	}
