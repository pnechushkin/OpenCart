           <form class="form-horizontal">
                ...
                <h2 id="ask_heading"><?php echo $heading_ask; ?></h2>
                ...
                <div class="form-group">
                  <div class="col-sm-12 text-right"><button type="button" id="button-question" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary"><?php echo $button_send; ?></button></div>
                </div>
              </form>
