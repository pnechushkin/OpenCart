...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="social_login_content_holder"></div>
      ...
      <p><a class="login_trigger" data-toggle="collapse" href="#login-box" aria-expanded="false"><?php echo $text_already_have_account; ?></a></p>
  <div class="quickcheckoutmid collapse" id="login-box">
    <div id="checkout">
      ...
      <?php if ($layout != '2') { ?>
		...
		<?php if ($cart_module) { ?>
		<div id="cart1">
		  <div class="quickcheckout-content cart"></div>
		</div>
		<?php } ?>
        
		<?php if ($voucher_module || $coupon_module || $reward_module) { ?>
	  <div id="voucher">
	  <div class="quickcheckout-content coupons"></div>
	</div>
    <?php } ?>
