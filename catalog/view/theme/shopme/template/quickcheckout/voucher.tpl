...
<div id="coupon-heading" class="field_heading"><?php echo $entry_coupon; ?></div>
...
<div id="voucher-heading" class="field_heading"><?php echo $entry_voucher; ?></div>
...
<div id="reward-heading" class="field_heading"><?php echo $entry_reward; ?></div>
