...
<?php echo $html; ?>
<div id="respond<?php echo $module; ?>"></div>
<div class="input-group">
<input type="text" id="email<?php echo $module; ?>" name="email" class="form-control" placeholder="<?php echo $entry_email; ?>" />
<span class="button-subscribe <?php echo $module; ?> input-group-addon btn btn-primary"><i class="fa fa-envelope"></i></span>
</div>
<?php if ($unsubscribe) { ?>
<div class="unsubscribe"><a class="button-unsubscribe <?php echo $module; ?>"><?php echo $button_unsubscribe; ?></a></div>
<?php } ?>
</div>
...
<a class="button-subscribe <?php echo $module; ?> btn btn-primary"><?php echo $button_subscribe; ?></a>
<?php if ($unsubscribe) { ?>
<a class="button-unsubscribe <?php echo $module; ?> btn btn-default"><?php echo $button_unsubscribe; ?></a>
<?php } ?>
</div>
</div>
</div>
