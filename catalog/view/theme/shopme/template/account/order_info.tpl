  ...
  <?php echo $column_left; ?>
    ...
    <tbody>
      ...
      <tr>
          ...
          <?php } ?>
          <br /><br />
		<a class="btn btn-sm btn-primary" href="<?php echo $product['reorder']; ?>"><?php echo $button_reorder; ?></a>
        <a class="btn btn-sm btn-default" href="<?php echo $product['return']; ?>"><?php echo $button_return; ?></a>
        </td>
