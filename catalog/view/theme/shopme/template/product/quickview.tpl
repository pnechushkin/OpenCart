...
<!-- AddThis Button END -->
   ...
   <div class="right" style="margin-left:360px">
    ...
    <a class="btn btn-icon" onclick="wishlist_qv.add('<?php echo $product_id; ?>');" data-toggle="tooltip" title="<?php echo $button_wishlist; ?>"><i class="fa fa-heart"></i></a>
    <a class="btn btn-icon" onclick="compare_qv.add('<?php echo $product_id; ?>');" data-toggle="tooltip" title="<?php echo $button_compare; ?>"><i class="icon-resize-small"></i></a>
    </div> 
