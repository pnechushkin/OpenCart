      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="basket">
    	<div class="cart-info">
          <table cellspacing="0">
            ...
            <a onclick="$('#basket').submit();" data-toggle="tooltip" title="<?php echo $button_update; ?>" class="btn btn-dark btn-icon-sm hidden-md hidden-lg"><i class="fa fa-refresh"></i></a>
             </td>
                <td class="price total mobile_hide"><?php echo $product['total']; ?></td>
                <td class="remove mobile_hide">
                <a onclick="$('#basket').submit();" data-toggle="tooltip" title="<?php echo $button_update; ?>" class="btn btn-dark btn-icon-sm"><i class="fa fa-refresh"></i></a>
                <a onclick="cart.remove('<?php echo $product['key']; ?>');" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-dark btn-icon-sm"><i class="fa fa-times"></i></a>
                </td>
              </tr>
              <?php } ?>
            ...
            <td class="price total mobile_hide"><?php echo $vouchers['amount']; ?></td>
             <td class="remove mobile_hide">
             <a onclick="voucher.remove('<?php echo $vouchers['key']; ?>');" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-dark btn-icon-sm"><i class="fa fa-times"></i></a>
             </td>
              </tr>
              <?php } ?>
            </tbody>
