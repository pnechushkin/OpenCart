...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      ...
      <a href="<?php echo $setting; ?>" data-toggle="tooltip" class="btn btn-default"><i class="fa fa-cog"></i> <?php echo $button_setting; ?></a>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <?php if (!$global_status) { ?>
		<div class="alert alert-warning"><?php echo $warning_disabled; ?></div>
        <?php } ?>
              ...
              <thead style="white-space:nowrap">
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'r.author') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left" style="width:45%"><?php echo $column_text; ?></td>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($question['question_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php echo $question['name']; ?></td>
                  <td class="text-left"><?php echo $question['author']; ?><br /><small>(<?php echo $question['email']; ?>)</small></td>
                  <td class="text-left"><?php echo $question['text']; ?></td>
                  <td class="text-left"><?php echo $question['date_added']; ?></td>
                  <td class="text-left">
                  <?php if($question['status']){ ?>
            	  <span class="label label-success" style="font-size:100%;"><?php echo $text_yes; ?></span>
            	  <?php }else{ ?>
                    <?php if($question['private']){ ?>
            	  	<span class="label label-danger" style="font-size:100%;"><?php echo $text_private; ?></span>
            	  	<?php }else{ ?>
                  	<span class="label label-danger" style="font-size:100%;"><?php echo $text_no; ?></span>
            	  	<?php } ?>
            	  <?php } ?>
                  </td>
                  <td class="text-left" style="white-space:nowrap;">
                  <?php if($question['answer']){ ?>
                  <span class="label label-success" style="font-size:100%;"><?php echo $text_answered; ?></span>
                  <?php }else{ ?>
                  <span class="label label-danger" style="font-size:100%;"><?php echo $text_not_answered; ?></span>
                  <?php } ?>
                  </td>
