...
<div class="row">
  ...
  <div class="product-layout col-lg-3 col-md-3 col-sm-6 col-xs-12">
    ...
    <div class="timer-block">
      ...
      <div class="timer_bestseller_<?php echo $product['product_id'];?>"></div>
    </div>

    <script type="text/javascript">
      $(document).ready(function() {
        $('.timer_bestseller_<?php echo $product['product_id'];?>').countdown({until: <?php echo $product['special_date_diff']; ?>});
      });
    </script>
